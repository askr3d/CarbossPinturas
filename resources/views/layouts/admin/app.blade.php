            ...
            <div class="w-1/6 h-fixed bg-gray-950 p-5 flex flex-col justify-between">
                ...
                <div class="flex flex-col justify-between gap-5">
                    ...
                    <nav class="flex flex-col justify-between items-center p-6 gap-4">
                        ...
                        <a href="/admin/product/productos" class="flex justify-center border-2 border-sky-400 gap-2 shadow-sm shadow-gray-600 hover:shadow-cyan-400 hover:shadow-lg bg-sky-400 rounded-md w-full text-center p-2 transition-shadow">
                        ...
                        <a href="/admin/service/servicios" class="flex justify-center border-2 border-rose-500 gap-2 shadow-sm shadow-gray-600 hover:shadow-pink-600 hover:shadow-lg bg-rose-500 rounded-md w-full text-center p-2 transition-shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
