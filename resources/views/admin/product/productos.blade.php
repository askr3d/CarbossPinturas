...
@section('contenido')
    ...
    <div class="flex flex-col">
        ...
        <div class="pt-8 pl-10">
            <table id="tablaProductos" class="display cell-border border shadow-lg border-gray-400 text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-center gap-2">
                                    <a href="{{ route('product.edit', $product->id_producto) }}" class="bg-sky-600 hover:bg-sky-700 py-1 px-4 rounded-md text-white font-bold flex gap-1">
